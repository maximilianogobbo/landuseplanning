...
```
Fonte: os autores (2023). Legenda: Figura produzida através da plotagem dos dados de geomcoberturasp, utilizando a função plot (_) para produção e a indicação do CRS como “WKT”. 
